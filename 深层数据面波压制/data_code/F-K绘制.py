...
if __name__ == "__main__":
    # 文件路径列表
    fk_files = [
        r"F-K数据_直达波切除(全部道)\U-Net_res_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\传统方法结果_norm_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\传统方法_res_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\CU-Net_res_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\original_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\CU-Net_result_muted_fk.npy",
        r"F-K数据_直达波切除(全部道)\U-Net_result_muted_fk.npy",
    ]
    
    # 输出文件夹
    output_folder = r'F-K图件_直达波切除(全部道)'
