...
class UNet(nn.Module):
    def __init__(self,
        ...
        self.down1 = DownWithCBAM(base_c, base_c * 2)    # 64->128
        self.down2 = DownWithCBAM(base_c * 2, base_c * 4) # 128->256
        self.down3 = DownWithCBAM(base_c * 4, base_c * 8) # 256->512
        self.down4 = DownWithCBAM(base_c * 8, base_c * 16) # 512->1024
 
        # 解码器 - 全部使用带CBAM的上采样
        self.up1 = UpWithCBAM(base_c * 16, base_c * 8) # 1024->512
        self.up2 = UpWithCBAM(base_c * 8, base_c * 4)  # 512->256
        self.up3 = UpWithCBAM(base_c * 4, base_c * 2) # 256->128
        self.up4 = UpWithCBAM(base_c * 2, base_c)  # 128->64
        
        # 输出层
        self.out_conv = OutConv(base_c, num_classes) # 32->num_classes
