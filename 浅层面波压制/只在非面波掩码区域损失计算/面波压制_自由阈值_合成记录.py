...
if __name__ == "__main__":
    ...
    # ========== 基础配置 ==========
    model_path = r"model\model_syn_1027\model_epoch_500.pth"
    input_segy_path = r"训练数据\cs_free.sgy"
    output_dir = r"无掩码测试结果\合成记录测试"
    ...
    # DEFAULT_THRESHOLD = 0.08           # 未指定区域的默认阈值
    ...
    DEFAULT_THRESHOLD = 1           # 未指定区域的默认阈值
