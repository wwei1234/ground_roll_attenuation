...
# 模型保存路径
model_dir = r"D:\桌面\面波压制\自监督高斯掩码\model_SYN_1113"
log_dir = r"D:\桌面\面波压制\自监督高斯掩码\training_logs_SYN_1113"
...
print("合并所有数据集...")
print("=" * 70)
combined_dataset = ConcatDataset(datasets_SYN)

print(f"\n合并后的数据集信息:")
print(f"  总数据集数量: {len(datasets_SYN)}")
