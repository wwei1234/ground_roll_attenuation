...
if __name__ == "__main__":
    ...
    # ========== 基础配置 ==========
    model_path = r"D:\桌面\面波压制\model\model_SYN&field_1126_U-Net\model_epoch_500.pth"
    input_segy_path = r"D:\桌面\面波压制\训练数据\modified_SN04.sgy"
    output_dir = r"D:\桌面\面波压制\field data\U-Net(shot89)2"
    ...
    VELOCITY_REGIONS = [
        {
            'velocity_range': (-220, -250),  # 炮点左侧，100-200 m/s
            'threshold': 0
        },
        {
            'velocity_range': (220, 250),  # 炮点左侧，100-200 m/s
        ...
        {
            'velocity_range': (-120,-220),  # 炮点左侧，100-200 m/s
            'threshold': 1
        },
    ]
